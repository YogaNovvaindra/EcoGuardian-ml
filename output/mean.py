    ...
    try:
        ...
        if latest_data:
            ...
            try:
                ...
                query = text(
                    """
                    INSERT INTO mean (id, temperature, humidity, mq135_co, mq135_alcohol, mq135_co2, mq135_toluen, mq135_nh4, mq135_aceton, 
                    mq2_h2, mq2_lpg, mq2_co, mq2_alcohol, mq2_propane, mq7_h2, mq7_lpg, mq7_ch4, mq7_co, mq7_alcohol, createdAt, updatedAt)
                    VALUES (:mean_id, :avg_temperature, :avg_humidity, :avg_mq135_co, :avg_mq135_alcohol, :avg_mq135_co2, :avg_mq135_toluen, :avg_mq135_nh4, :avg_mq135_aceton, 
                ...
                delete = text(
                    "DELETE FROM mean WHERE createdAt < NOW() - INTERVAL 7 DAY"
                )
